...
{
    partial class DodajUgovorIgracaForma
    {
        ...
        private void InitializeComponent()
        {
            ...
            btnDodaj = new Button(); btnOdustani = new Button();
            SuspendLayout();
            ...
            btnDodaj.Text = "Dodaj"; btnDodaj.Location = new Point(250, 540); btnDodaj.Size = new Size(140, 40); btnDodaj.Click += btnDodaj_Click;
            ...
            Controls.AddRange(new Control[] { label1, txtIgracId, label2, txtTimId, label3, dtpDatumOd, label4, dtpDatumDo, chkAktivan, label5, txtTipUgovora, label6, txtPlata, label7, txtBonusi, label8, txtKlauzula, label9, txtZabrana, label10, txtStatus, btnDodaj, btnOdustani });
            Name = "DodajUgovorIgracaForma"; Text = "Dodaj Ugovor Igrača";
            ResumeLayout(false);
            PerformLayout();
        }
